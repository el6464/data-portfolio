# Projet 5 : Suivi des lignes dans l’EDD
...
1. Extraction des données et dates de mise à jour via requêtes SQL
2. Intégration dans Power BI pour visualisation dynamique
