...
<!--
Si tu veux ajouter des images sécurisées (ex. version floutée ou basse résolution sur Cloudinary), tu peux remplacer ce message par des balises <img> avec les URLs adaptées.
-->
